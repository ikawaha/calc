...
func ParseEndpoint(cc *grpc.ClientConn, opts ...grpc.CallOption) (goa.Endpoint, interface{}, error) {
	var (
		...
		calcDivMessageFlag = calcDivFlags.String("message", "", "")
	)
	...
	)
	{
		...
		case "calc":
			...
			case "div":
				endpoint = c.Div()
				data, err = calcc.BuildDivPayload(*calcDivMessageFlag)
			}
		}
	}
	if err != nil {
...
func calcDivUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] calc div -message JSON

Div implements div.
    -message JSON: 

Example:
    `+os.Args[0]+` calc div --message '{
